...
void loop() {
   ...
   if ((millis() - prevStallMillis) > (1000 / stallPerSec) && (millis() - lastSpeedChange) > (1000 / speedChangePerSec) && !emergancyStop) {
      ...
      if ((encoderValLeft < stallThresholdLeft && actual_l_val && ideal_l_val) || (encoderValRight < stallThresholdRight && actual_r_val && ideal_r_val))
